...
HWND CWnd::Create(LPCTSTR lpCaption, DWORD dwStyle, int x, int y, int nWidth,
    int nHeight, HWND hParent, HMENU hMenu)
{
  return CreateWindow("WINDOW", lpCaption, dwStyle, x, y, nWidth, nHeight,
      hParent, hMenu, NULL, NULL);
}
